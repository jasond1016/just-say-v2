...
describe('resolveAppPaths', () => {
  it('uses source resources during dist-based development runs', () => {
    ...
    expect(paths).toEqual({
      ...
      nativeSenseVoiceServicePath: 'C:\\my_project\\just-say-v2\\resources\\local-service-native',
  ...
  it('resolves the tray and window icon from the published resources directory', () => {
    ...
    expect(paths).toEqual({
      ...
      nativeSenseVoiceServicePath: 'C:\\my_project\\just-say-v2\\release\\resources\\local-service-native',
