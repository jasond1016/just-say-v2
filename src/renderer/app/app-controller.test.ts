...
function createApi(overrides: Partial<AppApi> & {
  ...
  return {
    ...
    getPttHudState: overrides.getPttHudState ?? vi.fn(async () => ({ mode: 'hidden' as const })),
    onPttHudState: overrides.onPttHudState ?? (() => () => {}),
    ...
    dismissPttHud: overrides.dismissPttHud ?? vi.fn(async () => undefined),
